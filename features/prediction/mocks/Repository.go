...
func (_m *Repository) NewCity(NewCity prediction.Prediction) (prediction.Prediction, error) {
...
func (_m *Repository) SearchCity(NameCity string, NameCountry string, page uint, limit uint) ([]prediction.Prediction, uint, error) {
